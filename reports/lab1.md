...
При синтезе перед выводом дизайна выдаёт несколько предупреждей, но это не влияет на работу схемы. После синтеза в дизайне особо ничего нет, поскольку на данном этапе код ещё не переведён в вид непосредственных ячеек на плате
